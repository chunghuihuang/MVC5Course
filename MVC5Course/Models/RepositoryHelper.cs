namespace MVC5Course.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶資料彙總Repository Get客戶資料彙總Repository()
		{
			var repository = new 客戶資料彙總Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶資料彙總Repository Get客戶資料彙總Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶資料彙總Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
